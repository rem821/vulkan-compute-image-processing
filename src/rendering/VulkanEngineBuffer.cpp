 ...
 */
VkDeviceSize VulkanEngineBuffer::getAlignment(VkDeviceSize instanceSize, VkDeviceSize minOffsetAlignment) {
 ...
 *
 */
VkResult VulkanEngineBuffer::flushIndex(int index) { return flush(alignmentSize, index * alignmentSize); }
